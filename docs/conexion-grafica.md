...
sudo passwd ubuntu
```
*(Ingresa y confirma una contraseña segura cuando la terminal te lo solicite. No se mostrarán caracteres al escribirla por seguridad).*
...
1. Ve a la página de detalles de tu instancia y haz clic en la **Subnet** asignada (en la sección *Primary VNIC*).
